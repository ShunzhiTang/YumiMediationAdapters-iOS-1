...
- (void)timeOutTimer {
    ...
    [self stopTimer];
    [self adapter:self
        didInterstitialFailAd:[AdsYuMIError errorWithCode:AdYuMIRequestTimeOut description:@"Chartboost time out"]];
}
...
- (void)didFailToLoadInterstitial:(NSString *)location withError:(CBLoadError)error {
    ...
    [self stopTimer];
    [self adapter:self
        didInterstitialFailAd:[AdsYuMIError errorWithCode:AdYuMIRequestNotAd description:@"Chartboost no ad"]];
}
