 ...
 */
- (id)initWithFrame:(CGRect)frame webview:(BaiduMobAdNativeWebView *)webView;
 ...
 * object 包含文字内容和物料地址
 */
- (void)loadAndDisplayNativeAdWithObject:(BaiduMobAdNativeAdObject *)object
                              completion:(BaiduMobAdViewCompletionBlock)completionBlock;
