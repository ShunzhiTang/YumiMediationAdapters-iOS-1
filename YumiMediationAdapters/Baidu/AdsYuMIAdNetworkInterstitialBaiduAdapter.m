...
- (void)timeOutTimer {
    ...
    [self stopTimer];
    [self adapter:self
        didInterstitialFailAd:[AdsYuMIError errorWithCode:AdYuMIRequestTimeOut description:@"baidu ad time out"]];
}
/**
 *  插屏展示
 */
...
/**
 *  广告预加载成功#0	0x001182fa in -[AdsYuMIAdNetworkInterstitialBaiduAdapter interstitialSuccessToLoadAd:] at
 /Users/wxl/Documents/Zplay_Project/YMMergeSDK_Great/AdsYuMISDK/AdsYuMISDK/AdNetworkLibs/Baidu_SDK_v4.4/YUMIAdapter/AdsYuMIAdNetworkInterstitialBaiduAdapter.m:102
...
- (void)interstitialFailPresentScreen:(BaiduMobAdInterstitial *)_interstitial withError:(BaiduMobFailReason)reason {
    ...
    [self stopTimer];
    [self adapter:self
        didInterstitialFailAd:[AdsYuMIError errorWithCode:AdYuMIRequestNotAd description:@"baidu not ad"]];
}
