...
-(void)getAd{
  ...
  switch (self.adType) {
    ...
    case AdViewYMTypeLargeBanner:
      ...
      break;
    default:
      [self adapter:self didFailAd:[AdsYuMIError errorWithCode:AdYuMIRequestNotAd description:@"baidu adtype does not exist"]];
      return;
  }
...
-(void)failedDisplayAd:(BaiduMobFailReason) reason{
  ...
  if (BaiduMobFailReason_NOAD==reason) {
    [selfAdapter adapter:self didFailAd:[AdsYuMIError errorWithCode:AdYuMIRequestNotAd description:@"baidu not ad"]];
  }else{
