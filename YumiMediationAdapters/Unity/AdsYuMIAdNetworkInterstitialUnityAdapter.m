...
-(void)timeOutTimer{
  ...
  isReading=YES;
  [self stopTimer];
  [self adapter:self didInterstitialFailAd:[AdsYuMIError errorWithCode:AdYuMIRequestTimeOut description:@"Unity time out"]];
}
...
- (void)unityAdsDidError:(UnityAdsError)error withMessage:(NSString *)message{
  ...
  isReading=YES;
  [self stopTimer];
  [self adapter:self didInterstitialFailAd:[AdsYuMIError errorWithCode:AdYuMIRequestNotAd description:@"Unity no ad"]];
