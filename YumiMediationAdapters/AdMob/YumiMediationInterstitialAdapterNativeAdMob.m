...
- (void)requestAd {
    ...
    self.adLoader = [[GADAdLoader alloc] initWithAdUnitID:self.provider.data.key1 rootViewController:[self.delegate rootViewControllerForPresentingModalView] adTypes:adTypes options:@[option]];
...
didReceiveNativeAppInstallAd:(GADNativeAppInstallAd *)nativeAppInstallAd{
    ...
    if (nativeAppInstallAd.starRating) {
        ((UIImageView *)self.appInstallAdView.starRatingView).image = [self imageForStars:nativeAppInstallAd.starRating];
