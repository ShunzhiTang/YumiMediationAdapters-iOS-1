...
- (void)requestAdWithIsPortrait:(BOOL)isPortrait isiPad:(BOOL)isiPad {
    ...
    WMSize *ttSize = isiPad ?  [WMSize sizeBy:WMProposalSize_Banner600_300] :  [WMSize sizeBy:WMProposalSize_Banner600_100];
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        weakSelf.bannerView = [[WMBannerAdView alloc] initWithSlotID:weakSelf.provider.data.key2 size:ttSize rootViewController:weakSelf.delegate.rootViewControllerForPresentingModalView];
