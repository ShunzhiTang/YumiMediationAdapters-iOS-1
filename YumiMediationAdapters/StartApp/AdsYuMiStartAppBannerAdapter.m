...
-(void)getAd{
  ...
  if (bannerView == nil) {
    bannerView = [[STABannerView alloc] initWithSize:size origin:self.adNetworkView.center withView:[self viewControllerForPresentModalView].view withDelegate:self];
  }
