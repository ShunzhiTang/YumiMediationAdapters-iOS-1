...
-(void)timeOutTimer{
  ...
  isReading=YES;
  [self stopTimer];
  [self adapter:self didInterstitialFailAd:[AdsYuMIError errorWithCode:AdYuMIRequestTimeOut description:@"startApp time out"]];
}
/**
 *  插屏展示
 */
...
- (void)failedLoadAd:(STAAbstractAd *)ad withError:(NSError *)error {
  ...
  isReading=YES;
  [self stopTimer];
  [self adapter:self didInterstitialFailAd:[AdsYuMIError errorWithCode:AdYuMIRequestNotAd description:@"startApp no ad"]];
}
