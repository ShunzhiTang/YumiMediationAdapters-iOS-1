...
-(void)getAd{
  ...
  switch (self.adType) {
    ...
    case AdViewYMTypeLargeBanner:
      ...
      break;
    default:
      [self adapter:self didFailAd:[AdsYuMIError errorWithCode:AdYuMIRequestNotAd description:@"gdt native adtype does not exist"]];
      return;
  }
...
-(void)nativeAdSuccessToLoad:(NSArray *)nativeAdDataArray {
  ...
  if(![_currentAd.properties objectForKey:GDTNativeAdDataKeyIconUrl] ||![_currentAd.properties objectForKey:GDTNativeAdDataKeyDesc] )
  {
    [self adapter:self didFailAd:[AdsYuMIError errorWithCode:AdYuMIRequestNotAd description:@"GDT no ad"]];
    return;
  }
  ...
  str=[NSString stringWithFormat:str,@"100%",@"100%",@"50%",@"100%",@"100%",@"100%",@"100%",@"跳转",[_currentAd.properties objectForKey:GDTNativeAdDataKeyIconUrl],[_currentAd.properties objectForKey:GDTNativeAdDataKeyTitle],[_currentAd.properties objectForKey:GDTNativeAdDataKeyDesc],@"%"];
