...
- (void)getAd {
    ...
    self.gdtAdView = [[GDTMobBannerView alloc] initWithFrame:CGRectMake(0, 0, size.width, size.height)
                                                      appkey:self.provider.key1
                                                 placementId:self.provider.key2];
    ...
    if (IS_OS_7_OR_LATER) {
        ...
        self.gdtAdView.currentViewController.edgesForExtendedLayout =
