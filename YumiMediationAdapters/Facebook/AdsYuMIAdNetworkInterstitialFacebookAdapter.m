...
- (void)preasentInterstitial {
    if (self.interstitial.isAdValid) {
        [self.interstitial
            showAdFromRootViewController:[[[UIApplication sharedApplication] keyWindow] rootViewController]];
    }
}
...
- (void)interstitialAd:(FBInterstitialAd *)interstitialAd didFailWithError:(NSError *)error {
    ...
    [self stopTimer];
    [self adapter:self
        didInterstitialFailAd:[AdsYuMIError errorWithCode:AdYuMIRequestNotAd description:@"Facebook no ad"]];
}
